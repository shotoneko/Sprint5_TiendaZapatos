...
android {
    namespace = "modulo_05.sprint.shoes"
    compileSdk = 34

    defaultConfig {
        applicationId = "modulo_05.sprint.shoes"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //  implementation("androidx.navigation:navigation-compose:2.7.4") // Use the latest version
